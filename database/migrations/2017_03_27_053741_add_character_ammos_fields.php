...
class AddCharacterAmmosFields extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('character_ammos', function (Blueprint $table) {
            //
    ...
    public function down()
    {
        Schema::table('character_ammos', function (Blueprint $table) {
            //
            $table->dropColumn('character_id','ammo_name','ammo_type','ammo_class','ammo_count','damage_mod','damage_threshold_penetration','damage_resistance_penetration','jam_percentage','aoe_radius','weight');
        });
    }
}
